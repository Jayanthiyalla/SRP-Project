...
<div class="container-fluid">
	<form id='employee_frm'>
		...
		<div class="form-group">
			<label>Email</label>
			<input type="text" name="email" required="required" class="form-control" value="<?php echo isset($email) ? $email : "" ?>" />
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			?>
				<option class="opt" value="<?php echo $row['id'] ?>" data-did="<?php echo $row['department_id'] ?>" <?php echo isset($department_id) && $department_id == $row['department_id'] ? '' :"disabled" ?> 
				<?php echo isset($position_id) && $position_id == $row['id'] ? " selected" : '' ?> ><?php echo $row['name'] ?></option>
			<?php endwhile; ?>
			</select>
		</div>
		<div class="form-group">
			<label>Account No</label>
			<input type="number" name="account_no" required="required" class="form-control" value="<?php echo isset($account_no) ? $account_no : "" ?>" />
		</div>
		<div class="form-group">
			<label>Bank Name</label>
			<input type="text" name="bankname" required="required" class="form-control" value="<?php echo isset($bankname) ? $bankname : "" ?>" />
		</div>
