        ...
        <div class="card">
            <div class="card-header">
                ...
                <button class="btn btn-primary btn-sm btn-block col-md-3 float-right" type="button"
                    id="new_attendance_btn"><span class="fa fa-plus"></span> Add Attendance</button>
            </div>
            <div class="card-body">
                <table id="table" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                            // Initialize the $attendance array as an empty array
                            $attendance = array();
                        ...
                        <tr>
                                    ...
                                    <div class="col-sm-6" style="">
                                        <p>
                                            <small><b><?php echo $lt_arr[$k] . ": <br/>" ?>
                                                ...
                                                <span class="badge badge-danger rem_att"
                                                    data-id="<?php echo $attendance[$key]['log'][$k]['id'] ?>"><i
                            ...
                            <td>
                                <center>
                                    <button class="btn btn-sm btn-outline-danger remove_attendance"
                                        data-id="<?php echo $key ?>"><i class="fa fa-trash"></i></button>
                                </center>
                            </td>
                        </tr>
                        <?php
