...
?>
	...
	<script type="text/javascript">
		...
		// Inside the JavaScript code
				$.ajax({
    				url: 'ajax.php?action=send_email.php', // URL to the send_email.php file
   					 method: 'POST',
   					 data: data, // The email data to send
   					 success: function(response){
       					 if(response == 'Email sent successfully.'){
            				alert(response);
            				location.reload(); // Reload the page after sending the email
       		 			} else {
            				alert(response);
       				 }
   				 },
